...
from search import searcher, indexer #change
from lib.column import Column #change
from lib.source import Source #change
from lib.utils import not_allowed_chars #change
from random_forest import MyRandomForest #change
...
class SemanticLabeler:
    ...
    def read_data_sources(self, folder_paths):
        ...
        for folder_name in folder_paths:
            folder_path = os.getcwd()+ "/../../data/%s" % folder_name #change
            source_map = OrderedDict()
            data_folder_path = os.path.join(folder_path, "data")
            model_folder_path = os.path.join(folder_path, "model")
            print data_folder_path #change
            ...
            print self.dataset_map[folder_name] 
